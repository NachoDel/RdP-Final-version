...
file_path = "Secuencia/Secuencia.txt"

with open(file_path, 'r', encoding='utf-8') as file:
    data = file.read()

pattern = r'(T00)(.*?)(T01)(.*?)((T03)(.*?)(T04)(.*?)((T07)(.*?)(T08)(.*?)|(T06)(.*?)(T09)(.*?)(T10)(.*?))|(T02)(.*?)(T05)(.*?)((T07)(.*?)(T08)(.*?)|(T06)(.*?)(T09)(.*?)(T10)(.*?)))(T11)'
replacement = (r'\g<2>\g<4>\g<7>\g<9>\g<12>\g<14>\g<16>\g<18>\g<20>\g<22>\g<24>\g<27>\g<29>\g<31>\g<33>\g<35>')

invariant_patterns = [
    (r'T00.*?T01.*?T03.*?T04.*?T07.*?T08.*?T11', 'T00-T01-T03-T04-T07-T08-T11'),
    (r'T00.*?T01.*?T03.*?T04.*?T06.*?T09.*?T10.*?T11', 'T00-T01-T03-T04-T06-T09-T10-T11'),
    (r'T00.*?T01.*?T02.*?T05.*?T07.*?T08.*?T11', 'T00-T01-T02-T05-T07-T08-T11'),
    (r'T00.*?T01.*?T02.*?T05.*?T06.*?T09.*?T10.*?T11', 'T00-T01-T02-T05-T06-T09-T10-T11')
]
